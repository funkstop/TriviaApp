...
output.on('connection', (socket) => {
    ...
    socket.on('sendCanvas', () => {
        console.log('output client has requested for a canvas');
        //todo: send data of which canvas was updated and send it...
        output.emit('sendCanvasx', "3");
        input.emit('sendCanvasx', "3");
    })
})
