...
// todo: need a way to 'submit'.
// todo; need a way to retrieve final collaborative version.

socket.on('sendCanvasx', (data) => {
    console.log(data);
    // todo: update their page with the specific section they can draw on
    // todo: disable the other sections
    // todo: enable drawing capability.
